...
var PublishedComponent = /** @class */ (function () {
    function PublishedComponent(service) {
        this.service = service;
        this.projects = service.getCoding();
        console.log("AppComponent.projects:" + this.projects);
    }
    PublishedComponent.prototype.ngOnInit = function () {
    };
    PublishedComponent = __decorate([
        core_1.Component({
...
exports.PublishedComponent = PublishedComponent;
//# sourceMappingURL=published.component.js.map